...
var marshalTests = []struct {
	...
	{&struct {
		Title  string
		Amount int
	}{"War and Piece", 20}, "<value><struct><member><name>Amount</name><value><int>20</int></value></member><member><name>Title</name><value><string>War and Piece</string></value></member></struct></value>"},
	{&struct {
